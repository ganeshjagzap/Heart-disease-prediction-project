...
def inputlist():
    ...
    note = Label(disp, text="Note : This model is 84.19% accurate",
...
def predict1():
    ...
    pred.config(bg="seashell2")

    pred.geometry("1232x732")
    pred.maxsize(1232, 732)
    pred.minsize(1232, 732)
    lable1=Label(text="Heart disease prediction model",font="time 20 bold",fg="green",bg="seashell2").place(x=380,y=20)
    name = Label(pred, text="Name", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=100)
    Age = Label(pred, text="age", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=100)
    height = Label(pred, text="Height", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=150)
    weight = Label(pred, text="Weight", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=200)
    sex = Label(pred, text="Gender", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=150)
    cp_type = Label(pred, text="Chest pain type", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=200)
    Resting_BP = Label(pred, text="trestbps", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=250)
    SC = Label(pred, text="Serum Cholesterol", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=250)
    FBS = Label(pred, text="Fasting Blood Sugar", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=300)
    RER = Label(pred, text="Resting ECG Results", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=300)
    MHR = Label(pred, text="thalach", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=350)
    EIA = Label(pred, text="exang", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=350)
    ST_d = Label(pred, text="oldpeak", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=400)
    SPE = Label(pred, text="Slop", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=400)
    NMV = Label(pred, text="ca", font="time 12 bold", fg="black", bg="seashell2").place(x=200,y=450)
    Thalassemia = Label(pred, text="Thalassemia", font="time 12 bold", fg="black", bg="seashell2").place(x=650,y=450)
    ...
    thalval1 = IntVar()
    sextype = {"Male ", "Female"}
    ageentry = Entry(pred, textvariable=nameval).place(x=400,y=100)
...
l1 = Label(root, text="Welcome to disease prediction model", fg="blue", bg="seashell2", font="comicsansns 40 bold").place(x=140,y=150)
b2 = Button(root, text="User registration", font="time 20 bold", fg="red", bg="black", padx=20, pady=20,
            command=predict1, borderwidth=13).place(x=460,y=300)

member1 = Label(root, text=" Ganesh Jagzap ", fg="black", bg="seashell2", font="Arial 20 bold" ).place(x=870,y=600)
member2=Label(root,text="Prathamesh Patil",fg="black",bg="seashell2",font="Arial 20 bold").place(x=100,y=600)
